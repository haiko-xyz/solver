...
const TWO_POW_80: felt252 = 0x100000000000000000000;
...
pub impl MarketParamsStorePacking of StorePacking<MarketParams, PackedMarketParams> {
    fn pack(value: MarketParams) -> PackedMarketParams {
        ...
        slab2 += value.range.into() * TWO_POW_16.into();
        slab2 += value.min_sources.into() * TWO_POW_48.into();
        slab2 += value.max_age.into() * TWO_POW_80.into();
    ...
    fn unpack(value: PackedMarketParams) -> MarketParams {
        ...
        let range: u32 = ((slab2 / TWO_POW_16.into()) & MASK_32).try_into().unwrap();
        let min_sources: u32 = ((slab2 / TWO_POW_48.into()) & MASK_32).try_into().unwrap();
        let max_age: u64 = ((slab2 / TWO_POW_80.into()) & MASK_32).try_into().unwrap();
